...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" action="/Admin/Cate/sot" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/Admin/Cate/add"><i class="icon-font"></i>新增分类</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($cateList)): $i = 0; $__LIST__ = $cateList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><input name="id[]" value="<?php echo ($cate["id"]); ?>" type="checkbox"></td>
                            <td>
                                <input class="common-input sort-input" name="<?php echo ($cate["id"]); ?>" value="<?php echo ($cate["sort"]); ?>" type="text">
                            </td>
                            <td><?php echo ($cate["id"]); ?></td>
                            <td title=""><a target="_blank" href="#" title=""></a><?php echo ($cate["title"]); ?>
                            </td>
                            <td>
                                <a class="link-update" href="/Admin/Cate/upd?title=<?php echo ($cate["title"]); ?>&id=<?php echo ($cate["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确认删除?');" href="/Admin/Cate/del/id/<?php echo ($cate["id"]); ?>">删除</a>
                            </td>
